define("vite.config", ["require", "exports"], function (require, exports) {
    "use strict";
...
const chess3p = document.getElementById('canvas-3p-canvas');
// set canvas size
chess3p.width = width;
...
const createStructureCanvas = (width, height) => {
...
const drawTile = (ctx, x, y, tileColor) => {
...
const drawCoordinate = (text, xoffset, yoffset) => {
